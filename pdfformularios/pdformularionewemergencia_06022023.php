...
from app_cliente c INNER JOIN cesdb_arcombos.dns_nacionalidad n on c.nac_id=n.nac_id
INNER JOIN cesdb_arcombos.app_genero g on c.clie_genero=g.gen_gen
INNER JOIN cesdb_arcombos.app_estadocivil e on c.civil_id=e.civil_id
INNER JOIN cesdb_arcombos.dns_instruccion i on c.clie_instruccion=i.instruccion_id 
INNER JOIN cesdb_arextension.dns_convenios co on c.conve_id=co.conve_id
...
inner join cesdb_arextension.dns_gridplanmedicamentosemergencia medi on medi.anam_enlace=newem.anam_enlace
