...
$anam_fecharegistro=$rs_sihaydata->fields["anam_fecharegistro"];
  ...
  $datos_ro='';
  $rebicion_organos="select * from cesdb_arextension.dns_newgastroenterologiagridorgano a inner join cesdb_arcombos.dns_opcionorgano b on a.opcorg_id=b.opcorg_id where tiporg_nombre='CP' and anam_enlace='".$anam_enlace."'";
