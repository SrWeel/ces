...
$lee_plantilla=str_replace("-ucodigo-",$uni_codiog,$lee_plantilla);
  ...
  $datos_ap='';
  $antecedentes_personales="select * from cesdb_arextension.dns_antecedentespersonaleshospi a inner join cesdb_arcombos.dns_opcionantecedenteshospi b on a.opcioante_id=b.opcioante_id where clie_id='".$clie_id."'";
...
$lee_plantilla = str_replace("-logofondo-", $emp_logo, $lee_plantilla);
 ...
 ////DR
  ...
  $datos_af='';
  $antecedentes_familiares="select * from cesdb_arextension.dns_antecedentesfamiliareshospi a inner join cesdb_arcombos.dns_tipofamiliarhospi b on a.tipfam_id=b.tipfam_id where clie_id='".$clie_id."'";
...
/*  $datos_ro='';
  $rebicion_organos="select * from cesdb_arextension.dns_newhospitalizaciongridorgano a inner join cesdb_arcombos.dns_opcionorgano b on a.opcorg_id=b.opcorg_id where tiporg_nombre='CP' and anam_enlace='".$anam_enlace."'";
  ...
  $datos_ro='';
  $rebicion_organos="select * from cesdb_arcombos.dns_opcionorgano where opcorg_id!=99";
  $rs_ro = $DB_gogess->executec($rebicion_organos,array());
  if($rs_ro)
	{
		while (!$rs_ro->EOF) {
		
		  $rebicion_buorganos="select * from cesdb_arextension.dns_newhospitalizaciongridorgano a  where a.opcorg_id='".$rs_ro->fields["opcorg_id"]."' and anam_enlace='".$anam_enlace."'";
...
//  $lee_plantilla=str_replace("-anam_mamografia-",$anam_mamografia,$lee_plantilla);
 ...
 $datos_freg='';
 $fisco_regional="select * from cesdb_arextension.dns_newhospitalizaciongridexamenfisico a inner join cesdb_arcombos.dns_opcionexamenfisico b on a.opcexa_id=b.opcexa_id where tiporg_nombre='CP' and anam_enlace='".$anam_enlace."'";
 ...
 //diagnosticos
   $datos_diagnostico='';
   $cuentase=0;
   $diagosticos_rv="select * from cesdb_arextension.dns_newhospitalizaciondiagnosticoanamnesis where anam_enlace='".$anam_enlace."' limit 6";
...
$lista_detallesless='';
$listacamposcss="select * from dns_registrolesioneshospi inner join cesdb_arextension.dns_lesioneshospi on dns_registrolesioneshospi.les_id=cesdb_arextension.dns_lesioneshospi.les_id where anam_enlace='".$anam_enlace."'"; 
 $rs_camposcss = $DB_gogess->executec($listacamposcss,array()); 
   if($rs_camposcss)
   {
			 while (!$rs_camposcss->EOF) {
 ...
 $listacamposcssx="select * from  cesdb_arextension.dns_lesioneshospi"; 
