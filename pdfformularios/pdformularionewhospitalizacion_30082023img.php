...
$listacamposcss="select * from dns_registrolesiones inner join cesdb_arextension.dns_lesioneshospi on dns_registrolesiones.les_id=cesdb_arextension.dns_lesioneshospi.les_id where anam_enlace='".$anam_enlace."'"; 
...
$cuentase=0;	
$listacamposcss="select * from cesdb_arextension.dns_lesioneshospi"; 
   $rs_lessines = $DB_gogess->executec($listacamposcss,array());
   if($rs_lessines)
	{
			while (!$rs_lessines->EOF) {	
