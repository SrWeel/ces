...
//busca datos del paciente
    ...
    $logoc = '<img src="../archivo/'.$logo.'" alt="Logo" width="90px">';
    ...
    $centro_id = $rs_atencion->fields["centro_id"];
    $nomb_centro = $objformulario->replace_cmb("dns_centrosalud", "centro_id,centro_nombre", "where centro_id=", $centro_id, $DB_gogess);
    $uni_codiog = $objformulario->replace_cmb("dns_centrosalud", "centro_id,centro_codigo", "where centro_id=", $centro_id, $DB_gogess);
...
//paginar
    ...
    for($i=0;$i<$numero_entero;$i++)
    {
        ...
        // Reemplazos de datos del establecimiento
        ...
        // Reemplazos de datos del paciente
        ...
        // Reemplazos de edad y condición
        $lee_plantilla = str_replace("-edad-", $edad_texto, $lee_plantilla);
        $lee_plantilla = str_replace("-ced-", $condicion_edad_h, $lee_plantilla);
        $lee_plantilla = str_replace("-cedd-", $condicion_edad_d, $lee_plantilla);
        $lee_plantilla = str_replace("-cedm-", $condicion_edad_m, $lee_plantilla);
        $lee_plantilla = str_replace("-ceda-", $condicion_edad_a, $lee_plantilla);
