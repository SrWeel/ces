...
if($_SESSION['ces1313777_sessid_inicio']) {
    ...
    <body>
        ...
        <table class="tabla-datos">
            ...
            <tr>
                ...
                <td class="celda-dato">'.($diferencia->y > 0 ? 'AÑOS' : ($diferencia->m > 0 ? 'MESES' : 'DÍAS')).'</td>
            </tr>
        </table>
        ...
        $html_reporte .= '
            <tr>
                <td colspan="5" class="sin-datos">
                    No hay notas de enfermería registradas para este paciente
                </td>
            </tr>';
    }
    ...
    $nombre_archivo = "NotasEnfermeria_".$hc."_".$separa_fecha_hora[0].".pdf";
