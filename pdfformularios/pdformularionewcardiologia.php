...
/* 
 ...
 /* $datos_ro='';
  $rebicion_organos="select * from cesdb_arextension.dns_newcardiologiagridorgano a inner join cesdb_arcombos.dns_opcionorganonewconext b on a.opcorg_id=b.opcorg_id where tiporg_nombre='CP' and anam_enlace='".$anam_enlace."'";
  ...
  if($rs_ro)
	{
		while (!$rs_ro->EOF) {
		  ...
		  $rebicion_buorganos="select * from cesdb_arextension.dns_newcardiologiagridorgano a  where opcorg_id='".$rs_ro->fields["opcorg_id"]."' and anam_enlace='".$anam_enlace."'";
...
// $sig_vitales="select * from dns_signosvitales where anam_enlace='".$anam_enlace."' order by signovita_fecharegistro desc limit 1";
 ...
 /*$datos_freg='';
 $fisco_regional="select * from cesdb_arextension.dns_newcardiologiagridexamenfisico a inner join cesdb_arcombos.dns_opcionexamenfisico b on a.opcexa_id=b.opcexa_id where tiporg_nombre='CP' and anam_enlace='".$anam_enlace."'";
  ...
  if($rs_freg)
	{
		while (!$rs_freg->EOF) {
		   ...
		   $fisco_regionalbusca="select * from cesdb_arextension.dns_newcardiologiagridexamenfisico a inner join cesdb_arcombos.dns_opcionexamenfisico b on a.opcexa_id=b.opcexa_id where  a.opcexa_id='".$rs_freg->fields["opcexa_id"]."' and anam_enlace='".$anam_enlace."'";
 ...
 //diagnosticos
   $datos_diagnostico='';
   $cuentase=0;
   $diagosticos_rv="select * from cesdb_arextension.dns_newcardiologiadiagnosticoanamnesis where anam_enlace='".$anam_enlace."' limit 6";
