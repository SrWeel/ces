...
LEFT JOIN app_usuario AS u ON ih.usua_id = u.usua_id
WHERE a.clie_id = ? AND ih.gb_id > 0
ORDER BY ih.imphos_fecharegistro DESC, gb.gb_nombre ASC";

$rs_grupo_b = $DB_gogess->executec($sql_grupo_b, array($clie_id));
...
LEFT JOIN app_usuario AS u ON ih.usua_id = u.usua_id
WHERE a.clie_id = ? AND ih.gc_id > 0
ORDER BY ih.imphos_fecharegistro DESC, gc.gc_nombre ASC";

$rs_grupo_c = $DB_gogess->executec($sql_grupo_c, array($clie_id));
    // ===============================================
