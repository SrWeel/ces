...
if($_SESSION['ces1313777_sessid_inicio']) {
    ...
    $decodifica='';
    $decodifica=base64_decode($_GET["ssr"]);
    ...
    // ========================================================================
    // CONSULTA CONSOLIDADA: TODAS LAS NOTAS DE ENFERMERÍA DE LA ATENCIÓN
    // ========================================================================
    $sql_notas = "SELECT g.*, u.usua_nombre, u.usua_apellido, u.usua_codigo, u.usua_codigoiniciales,
                  e.enferm_id, e.enferm_enlace
    ...
    $rs_notas = $DB_gogess->executec($sql_notas, array($atenc_id));
    ...
    <body>
        ...
        <table class="header-tabla">
            <tr>
                <td class="logo-cell">
                    <img src="../archivo/'.$logo.'" alt="Logo CES">
                </td>
                <td class="titulo-cell">
                    <div class="titulo-principal">'.$emp_nombre.'</div>
                    <div class="subtitulo">NOTAS DE ENFERMERÍA - REPORTE CONSOLIDADO</div>
                </td>
        ...
        <!-- TABLA DE DATOS DEL ESTABLECIMIENTO Y PACIENTE -->
        <table class="tabla-datos">
            ...
            <!-- FILA 2: ENCABEZADOS VERDES (6 columnas) -->
            <tr>
            ...
            <!-- FILA 4: ENCABEZADOS VERDES (8 columnas) -->
            <tr>
        ...
        <table class="tabla-notas">
            <thead>
                <tr>                
                    <td class="titulo-azul" colspan="5">
                ...
                <tr>
                    ...
                    <th width="10%">HORA</th>
                    <th width="45%">NOTAS DE ENFERMERÍA</th>
    ...
    if($rs_notas && !$rs_notas->EOF) {
        while (!$rs_notas->EOF) {
            $hay_datos = true;
            $contador_notas++;

            $fecha = $rs_notas->fields["genfermeria_fecha"];
            $hora = $rs_notas->fields["genfermeria_hora"];
            $anotaciones = nl2br(htmlspecialchars($rs_notas->fields["genfermeria_anotaciones"]));
            $fecha_registro = $rs_notas->fields["genfermeria_fecharegistro"];

            // Información del usuario
            $nombre_usuario = trim($rs_notas->fields["usua_nombre"].' '.$rs_notas->fields["usua_apellido"]);
            $codigo_usuario = $rs_notas->fields["usua_codigo"];
            $iniciales_usuario = $rs_notas->fields["usua_codigoiniciales"];
        ...
        $html_reporte .= '
            <tr>
                <td colspan="5" class="sin-datos">
                    No hay notas de enfermería registradas para esta atención
                </td>
            </tr>';
    }
    ...
    $html_reporte .= '
        ...
        <div class="footer">
            <p><strong>REPORTE CONSOLIDADO - Total de notas: '.$contador_notas.'</strong></p>
            <p>'.$emp_piedepagina.'</p>
    ...
    $nombre_archivo = "NotasEnfermeria_Consolidado_".$hc."_".$separa_fecha_hora[0].".pdf";
