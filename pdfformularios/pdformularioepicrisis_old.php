...
$anam_fecharegistro=$rs_sihaydata->fields["anam_fecharegistro"];
 ...
 $resumen_clinico="select * from  cesdb_aroriginal.dns_epicrisisanamesis where anam_resumenclinico='".$anam_resumenclinico."'";
 ...
 /* $antecedentes_personales="select * from cesdb_arextension.dns_antecedentespersonales a inner join cesdb_arcombos.dns_opcionantecedentes b on a.opcioante_id=b.opcioante_id where clie_id='".$clie_id."'";
  ...
  $datos_ro='';
  $rebicion_organos="select * from cesdb_arextension.dns_epicrisisgridorgano a inner join cesdb_arcombos.dns_opcionorgano b on a.opcorg_id=b.opcorg_id where tiporg_nombre='CP' and anam_enlace='".$anam_enlace."'";
...
//==================================================
 ...
 $datos_freg='';
 $fisco_regional="select * from cesdb_arextension.dns_epicrisisgridexamenfisico a inner join cesdb_arcombos.dns_opcionexamenfisico b on a.opcexa_id=b.opcexa_id where tiporg_nombre='CP' and anam_enlace='".$anam_enlace."'";
 ...
 //diagnosticos
   $datos_diagnostico='';
   $cuentase=0;
   $diagosticos_rv="select * from cesdb_arextension.dns_epicrisisdiagnosticoanamnesis where anam_enlace='".$anam_enlace."' limit 6";
