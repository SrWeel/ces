...
if($_SESSION['ces1313777_sessid_inicio']) {
    ...
    // CONSULTA CONTROL PREOPERATORIO
    $sql_preoperatorio = "
    SELECT 
        g.gconpre_id, 
        g.enferm_enlace,
    ...
    ORDER BY c.cont_descripcion ASC, g.gconpre_fecharegistro ASC
";

    $rs_preoperatorio = $DB_gogess->executec($sql_preoperatorio, array($enferm_enlace));
        ...
        <table class="header-tabla">
            <tr>
                ...
                <td class="titulo-cell">
                    ...
                    <div class="subtitulo">CONTROL PREOPERATORIO</div>
                </td>
        ...
        $html_reporte .= '
            <tr>
                <td colspan="6" class="sin-datos">
                    No hay registros de control preoperatorio para este paciente
                </td>
            </tr>';
    }
    ...
    $nombre_archivo = "ControlPreoperatorio_".$hc."_".$separa_fecha_hora[0].".pdf";
