...
if ($_SESSION['ces1313777_sessid_inicio']) {
  ...
  $logoc = '<img src="../archivo/' . $logo . '" alt="125x125" width="180px">';
  ...
  $datos_ap = '';
  $antecedentes_personales = "select * from cesdb_arextension.dns_antecedentespersonalesnewconext a inner join cesdb_arcombos.dns_opcionantecedentesnewconext b on a.opcioante_id=b.opcioante_id where clie_id='" . $clie_id . "'";
...
*/
  ...
  */
  ...
  $datos_af = '';
  $antecedentes_familiares = "select * from cesdb_arextension.dns_antecedentesfamiliaresnewconext a inner join cesdb_arcombos.dns_tipofamiliarnewconext b on a.tipfam_id=b.tipfam_id where clie_id='" . $clie_id . "'";
  ...
  /*$datos_ro='';
  $rebicion_organos="select * from cesdb_arextension.dns_newconsultaexternagridorgano a inner join cesdb_arcombos.dns_opcionorganonewconext b on a.opcorg_id=b.opcorg_id where tiporg_nombre='CP' and anam_enlace='".$anam_enlace."'";
  ...
  $datos_ro = '';
  $rebicion_organos = "select * from cesdb_arcombos.dns_opcionorganonewconext";
  $rs_ro = $DB_gogess->executec($rebicion_organos, array());
  if ($rs_ro) {
    while (!$rs_ro->EOF) {

      $rebicion_buorganos = "select * from cesdb_arextension.dns_newconsultaexternagridorgano a  where opcorg_id='" . $rs_ro->fields["opcorg_id"] . "' and anam_enlace='" . $anam_enlace . "'";
  ...
  $rebicion_organossp = "select * from cesdb_arcombos.dns_opcionorganonewconext";
  ...
  /* $datos_freg='';
 $fisco_regional="select * from cesdb_arextension.dns_newconsultaexternagridexamenfisico a inner join cesdb_arcombos.dns_opcionexamenfisico b on a.opcexa_id=b.opcexa_id where tiporg_nombre='CP' and anam_enlace='".$anam_enlace."'";
  ...
  $datos_freg = '';
  $fisco_regional = "select * from cesdb_arcombos.dns_opcionexamenfisico order by 	opcexa_orden asc";
  $rs_freg = $DB_gogess->executec($fisco_regional, array());
  if ($rs_freg) {
    while (!$rs_freg->EOF) {

      $fisco_regionalbusca = "select * from cesdb_arextension.dns_newconsultaexternagridexamenfisico a inner join cesdb_arcombos.dns_opcionexamenfisico b on a.opcexa_id=b.opcexa_id where  a.opcexa_id='" . $rs_freg->fields["opcexa_id"] . "' and anam_enlace='" . $anam_enlace . "'";
  ...
  $datos_diagnostico = '';
  $cuentase = 0;
  $diagosticos_rv = "select * from cesdb_arextension.dns_newconsultaexternadiagnosticoanamnesis where anam_enlace='" . $anam_enlace . "' limit 6";
