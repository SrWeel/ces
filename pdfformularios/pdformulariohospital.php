...
$anam_fecharegistro=$rs_sihaydata->fields["anam_fecharegistro"];
  ...
  if($filtro==1)
  {
    $antecedentes_personales="select * from cesdb_arextension.dns_antecedentespersonales a inner join cesdb_arcombos.dns_opcionantecedentes b on a.opcioante_id=b.opcioante_id where clie_id='".$clie_id."' and a.usua_id='".$_SESSION['ces1313777_sessid_inicio']."'";
  }
  else
  {
  ...
  if($filtro==1)
  {
  $antecedentes_familiares="select * from cesdb_arextension.dns_antecedentesfamiliares a inner join cesdb_arcombos.dns_tipofamiliar b on a.tipfam_id=b.tipfam_id where clie_id='".$clie_id."' and a.usua_id='".$_SESSION['ces1313777_sessid_inicio']."'";
  }
  else
  {
  ...
  $datos_ro='';
  $rebicion_organos="select * from cesdb_arextension.dns_hospitalgridorgano a inner join cesdb_arcombos.dns_opcionorgano b on a.opcorg_id=b.opcorg_id where tiporg_nombre='CP' and anam_enlace='".$anam_enlace."'";
...
//==================================================
 ...
 $datos_freg='';
 $fisco_regional="select * from cesdb_arextension.dns_hospitalgridexamenfisico a inner join cesdb_arcombos.dns_opcionexamenfisico b on a.opcexa_id=b.opcexa_id where tiporg_nombre='CP' and anam_enlace='".$anam_enlace."'";
 ...
 //diagnosticos
   $datos_diagnostico='';
   $cuentase=0;
   $diagosticos_rv="select * from cesdb_arextension.dns_hospitaldiagnosticoanamnesis where anam_enlace='".$anam_enlace."' limit 6";
