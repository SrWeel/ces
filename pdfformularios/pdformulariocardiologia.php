...
$anam_fecharegistro=$rs_sihaydata->fields["anam_fecharegistro"];
  ...
  $datos_ro='';
  $rebicion_organos="select * from cesdb_arextension.dns_cardiologiagridorgano a inner join cesdb_arcombos.dns_opcionorgano b on a.opcorg_id=b.opcorg_id where tiporg_nombre='CP' and anam_enlace='".$anam_enlace."'";
...
//==================================================
 ...
 $datos_freg='';
 $fisco_regional="select * from cesdb_arextension.dns_cardiologiagridexamenfisico a inner join cesdb_arcombos.dns_opcionexamenfisico b on a.opcexa_id=b.opcexa_id where tiporg_nombre='CP' and anam_enlace='".$anam_enlace."'";
 ...
 //diagnosticos
   $datos_diagnostico='';
   $cuentase=0;
   $diagosticos_rv="select * from cesdb_arextension.dns_cardiologiadiagnosticoanamnesis where anam_enlace='".$anam_enlace."' limit 6";
