...
if($_SESSION['ces1313777_sessid_inicio']) {
    ...
    // ========================================================================
    // CONSULTA CONSOLIDADA: TODAS LAS ACTIVIDADES GENERALES DE LA ATENCIÓN
    // ========================================================================
    $sql_actividades = "
    SELECT 
        ag.actemfgen_id, 
...
";
    ...
    $rs_actividades = $DB_gogess->executec($sql_actividades, array($atenc_id));
        ...
        <table class="header-tabla">
            <tr>
                ...
                <td class="titulo-cell">
                    ...
                    <div class="subtitulo">ACTIVIDADES GENERALES DE ENFERMERÍA - REPORTE CONSOLIDADO</div>
                </td>
        ...
        while (!$rs_actividades->EOF) {
            ...
            $html_reporte .= '
                <tr>
                    ...
                    <td class="observacion">'.nl2br($observacion ? $observacion : '-').'</td>
                    <td>'.$info_usuario.'</td>
        ...
        $html_reporte .= '
            <tr>
                <td colspan="4" class="sin-datos">
                    No hay actividades generales registradas para esta atención
                </td>
            </tr>';
    }
    ...
    $html_reporte .= '
        ...
        <div class="footer">
            <p><strong>REPORTE CONSOLIDADO - Total de actividades: '.$contador_actividades.'</strong></p>
            <p>'.$emp_piedepagina.'</p>
    ...
    $nombre_archivo = "ActividadesGenerales_Consolidado_".$hc."_".$separa_fecha_hora[0].".pdf";
