   ...
   if($rs_aevolucion)
	{
		while (!$rs_aevolucion->EOF) {
		  ...
		  //$tipo_terapia='';
		 // $tipo_terapia=$objformulario->replace_cmb("cesdb_arextension.dns_tipoterapia","tipotera_id,tipotera_nombre","where tipotera_id=",$rs_aevolucion->fields["tipotera_id"],$DB_gogess); 	  
