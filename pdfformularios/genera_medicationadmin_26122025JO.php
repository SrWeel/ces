...
//    echo $enferm_enlace;
    ...
    // PASO 2: CONSULTAR LA ADMINISTRACIÓN DE MEDICAMENTOS (CON TODAS LAS RELACIONES)
    $sql_medicamentos = "
    SELECT 
        m.gadmmedi_id, 
...
";
    ...
    <body>
        ...
        <table class="tabla-medicamentos">
            ...
            <thead>
            <tr>                
                <td class="titulo-azul" colspan="4">B. ADMINISTRACIÓN DE MEDICAMENTOS PREESCRITOS </td>
                </tr>
                <tr>                
        ...
        $html_reporte .= '
            <tr>
                <td colspan="7" class="sin-datos">
                    No hay administración de medicamentos registrada para este paciente
                </td>
            </tr>';
    }
    ...
    $nombre_archivo = "AdministracionMedicamentos_".$hc."_".$separa_fecha_hora[0].".pdf";
