...
$lee_plantilla = str_replace("-logofondo-", $emp_logo, $lee_plantilla);
  ...
  $datos_ro='';
  $rebicion_organos="select * from cesdb_arextension.dns_ginecologiagridorgano a inner join cesdb_arcombos.dns_opcionorgano b on a.opcorg_id=b.opcorg_id where tiporg_nombre='CP' and anam_enlace='".$anam_enlace."'";
...
//==================================================
 ...
 $datos_freg='';
 $fisco_regional="select * from cesdb_arextension.dns_ginecologiagridexamenfisico a inner join cesdb_arcombos.dns_opcionexamenfisico b on a.opcexa_id=b.opcexa_id where tiporg_nombre='CP' and anam_enlace='".$anam_enlace."'";
 ...
 //diagnosticos
   $datos_diagnostico='';
   $cuentase=0;
   $diagosticos_rv="select * from cesdb_arextension.dns_ginecologiadiagnosticoanamnesis where anam_enlace='".$anam_enlace."' limit 6";
