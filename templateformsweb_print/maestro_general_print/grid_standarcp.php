...
//echo $lista_servicios;
 ...
 if($rs_data)
 {
  ...
  ?>
   ...
   <tr>
   <?php
    echo '<td bgcolor="#DFE9EE" style="font-size:12px" ><b>VALOR TOTAL</b></td>';
	for($i=1;$i<count($fie_camposgridselect);$i++)
	 {
      echo '<td bgcolor="#DFE9EE" style="font-size:12px" ><b>'.@$suma_data[$fie_camposgridselect[$i]].'</b></td>';
	 }
	?>
