...
$lista_espe="select distinct prof_nombre from beko_recibodetalle inner join cesdb_arextension.dns_profesion profe on beko_recibodetalle.prof_id=profe.prof_id inner join dns_especialidad on dns_especialidad.especi_id=profe.especienc_id where doccab_id='".$rscampos_valor->fields["doccab_id"]."'";
