...
$lista_data="select * from  lpin_comprobantecontable where comcont_tabla='beko_documentocabecera' and comcont_idtabla='".$xml."' order by comcont_fecha asc" ;
$registros_data = $DB_gogess->executec($lista_data,array());
...
$lista_data="select * from  lpin_comprobantecontable where comcont_tablas='beko_documentocabecera' and comcont_idtablas='".$xml."' order by comcont_fecha asc";
$registros_data = $DB_gogess->executec($lista_data,array());
...
$lista_data="select * from  lpin_comprobantecontable where comcont_anulado=0 and comcont_tabla='beko_documentocabecera' and comcont_idtabla='".$xml."' order by comcont_fecha asc";
$registros_data = $DB_gogess->executec($lista_data,array());
...
//busca cruces
$busca_crixe="select * from lpin_crucedocumentos join cesdb_arextension.lpin_crucedetalle on lpin_crucedocumentos.crudoc_enlace = cesdb_arextension.lpin_crucedetalle.crudoc_enlace where crudet_documentoventa ='".$xml."'";
$registros_crixe = $DB_gogess->executec($busca_crixe,array());


$lista_data="select * from  lpin_comprobantecontable where comcont_tabla='lpin_crucedocumentos' and comcont_idtabla='".$registros_crixe->fields["crudoc_id"]."' order by comcont_fecha asc";
$registros_data = $DB_gogess->executec($lista_data,array());
