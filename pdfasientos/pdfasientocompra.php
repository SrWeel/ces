...
';
  ...
  //busca cruce
  $busca_cruse = "select * from lpin_crucedocumentos inner join cesdb_arextension.lpin_crucedetalle on lpin_crucedocumentos.crudoc_enlace=cesdb_arextension.lpin_crucedetalle.crudoc_enlace where crudet_documento='" . $xml . "'";
