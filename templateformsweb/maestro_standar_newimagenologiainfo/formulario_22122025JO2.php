...
<script>
    ...
    function showCurrentImage() {
        ...
        // Esto previene la pantalla negra en recargas
        try {
            cornerstone.getEnabledElement(element);
            // Si llegamos aquí, está habilitado - deshabilitarlo primero
            console.log('♻️ Elemento ya habilitado, deshabilitando primero...');
            cornerstone.disable(element);
            DICOM_VIEWER.enabledElements.delete('currentDicomImage');
        } catch(e) {
            // No estaba habilitado, ok
        ...
        }, 50); // 50ms de pausa para limpieza de WebGL
    }
    ...
    function loadDicomPreviewFromServer(files) {
        ...
        if (DICOM_VIEWER.images.length > 0) {
            ...
            // Pequeña pausa antes de mostrar para asegurar que el DOM está listo
            setTimeout(function() {
                showCurrentImage();
            }, 100);
        } else {
