...
<script>
    ...
    var DICOM_VIEWER = {
        ...
        loadStartTime: 0,
        loadTimer: null,
        successTimeout: null // ⏱️ Timeout para limpiar mensaje de éxito
    };
    ...
    function clearSuccessTimeout() {
        if (DICOM_VIEWER.successTimeout) {
            clearTimeout(DICOM_VIEWER.successTimeout);
