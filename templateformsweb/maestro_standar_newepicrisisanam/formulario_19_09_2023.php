...
{
     $busca_diag="select count(*) as total from cesdb_arextension.dns_epicrisisdiagnosticoanamnesis where anam_enlace='".$objformulario->contenid["anam_enlace"]."'";
     $rs_diag = $DB_gogess->executec($busca_diag,array());     
	 $bandera_cie=$rs_diag->fields["total"];
}
else
{
     $busca_diag="select count(*) as total from cesdb_arextension.dns_epicrisisdiagnosticoanamnesis where anam_enlace='".$objformulario->sendvar["anam_enlacex"]."'";
     $rs_diag = $DB_gogess->executec($busca_diag,array());	 
	 $bandera_cie=$rs_diag->fields["total"];
}
