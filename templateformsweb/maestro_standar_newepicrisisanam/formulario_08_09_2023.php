...
if($bandera_cie==0)
{
	...
	{		
		...
		$busca_listadiag="select * from cesdb_arextension.dns_protocolodiagnosticospre where protoop_enlace='".$rs_protocolox->fields["protoop_enlace"]."' order by 1 asc";
		...
		//===============================================================================
		$busca_listadiag="select * from cesdb_arextension.dns_protocolodiagnosticospost where protoop_enlace='".$rs_protocolox->fields["protoop_enlace"]."' order by 1 asc";
		$rs_listd = $DB_gogess->executec($busca_listadiag,array());
		if($rs_listd)
		{
		  while (!$rs_listd->EOF) {	
