...
{
     $busca_diag="select count(*) as total from cesdb_arextension.dns_hospitaldiagnosticoexterna where conext_enlace='".$objformulario->contenid["conext_enlace"]."'";
     $rs_diag = $DB_gogess->executec($busca_diag,array());
	 
	 $lista_nex="select diagn_cie from cesdb_arextension.dns_hospitaldiagnosticoexterna where conext_enlace='".$objformulario->contenid["conext_enlace"]."'";
     
	 $bandera_cie=$rs_diag->fields["total"];
}
else
{
     $busca_diag="select count(*) as total from cesdb_arextension.dns_hospitaldiagnosticoexterna where conext_enlace='".$objformulario->sendvar["conext_enlacex"]."'";
     $rs_diag = $DB_gogess->executec($busca_diag,array());
	 
	 $lista_nex="select diagn_cie from cesdb_arextension.dns_hospitaldiagnosticoexterna where conext_enlace='".$objformulario->sendvar["conext_enlacex"]."'";
...
//@$objformulario->sendvar["protoop_idenlacex"]=$protoop_idenlace;
	...
	$rs_budiag = $DB_gogess->executec($busca_diag,array());	
	 ...
	 $busca_listadiag="select * from cesdb_arextension.dns_hospitaldiagnosticoanamnesis where anam_enlace='".$rs_budiag->fields["anam_enlace"]."' and  diagn_cie not in(".$lista_nex.")  order by 1 asc";
