...
$lista_espe="select distinct usuaat_id,dns_especialidad.especi_id from beko_recibodetalle inner join cesdb_arextension.dns_profesion profe on beko_recibodetalle.prof_id=profe.prof_id inner join dns_especialidad on dns_especialidad.especi_id=profe.especienc_id where doccab_id='".$doccab_id."'";
