...
$sql_inserta="INSERT INTO `dns_antecedentesfamiliares` (anam_enlace,antef_informacion,antef_descripcion,usua_id,antef_fecha) VALUES ('".$_POST["enlace"]."','".$_POST["antef_informacionx"]."', '".$_POST["antef_descripcionx"]."','".$_SESSION['ces1313777_sessid_inicio']."','".date("Y-m-d H:i:s")."')";
