...
<table width="300" border="1" cellspacing="0" cellpadding="0">
	...
	<tr>
      ...
      <td> 
	  <select name="cuentb_idac" id="cuentb_idac" style="width:200px">
      <option value="">--seleccionar cliente--</option>
	  <?php
	    $objformulario->fill_cmb("lpin_cuentasbancarias_vista","cuentb_id,entif_nombre,cuentb_cuentacontable",@$cuentb_idac," order by entif_nombre asc",$DB_gogess);
	  ?> 
    </select>
...
function actualizar_cabecera() {
   ...
   if($('#crb_fechaac').val()=='')
   {
     alert("Por favor llenar todos los campos de modificacion");
	 return false;
   }
    if($('#crb_ncomprobanteac').val()=='')
   {
     alert("Por favor llenar todos los campos de modificacion");
	 return false;
   }
   ...
   else
   {
     return false;
		...
		$("#divBody_actcabecera").load("templateformsweb/maestro_standar_macobropagopl/actualiza/act_data.php", {
			...
			cuentb_idac:$('#cuentb_idac').val(),
			cuentb_idactual:$('#cuentb_id').val()
		}, function(result) {
