...
$sql_inserta="INSERT INTO `dns_horarioterapia` (horat_fecha,horat_horai,horat_horaf,horat_area,horat_proceso,horat_fecharegistro,atenc_enlace,usua_id ) VALUES ('".$_POST["horat_fechax"]."','".str_replace(' ', '',$_POST["horat_horaix"])."', '".str_replace(' ', '',$_POST["horat_horafx"])."','".$_POST["horat_areax"]."','".$_POST["horat_procesox"]."','".date("Y-m-d")."','".$_POST["enlace"]."','".$_SESSION['ces1313777_sessid_inicio']."')";
