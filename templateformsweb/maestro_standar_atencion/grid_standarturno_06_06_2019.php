...
if($_POST["opcion"]==1)
{
		...
		if($_POST[$campo_id."x"]>0)
			...
			else
			{
		     ...
		     //insertar turno
               $busca_siguiente="select gridtur_turno from dns_gridturnos inner join dns_atencion on dns_gridturnos.atenc_enlace=dns_atencion.atenc_enlace where especi_id=".$_POST["especi_idx"]." and gridtur_fecha='".date("Y-m-d")."' and dns_atencion.centro_id='".$_SESSION['ces1313777_centro_id']."' order by gridtur_turno desc limit 1"; 
			   
			   $busca_siguiente="select gridtur_turno from dns_gridturnos where especi_id=".$_POST["especi_idx"]." and gridtur_fecha='".date("Y-m-d")."' and centro_id='".$_SESSION['ces1313777_centro_id']."' order by gridtur_turno desc limit 1"; 
             ...
             @$_POST["centro_idx"]=$_SESSION['ces1313777_centro_id'];
              //insertar turno		
