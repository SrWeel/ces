...
if($_POST["opcion"]==1)
{
		...
		if($_POST[$campo_id."x"]>0)
			...
			else
			{
		     ...
		     //insertar turno
               $busca_siguiente="select gridtur_turno from cesdb_arextension.dns_gridturnos where especi_id=".$_POST["especi_idx"]." and gridtur_fecha='".date("Y-m-d")."' and centro_id='".$_SESSION['ces1313777_centro_id']."' and usuaat_id=".$_POST["usuaat_idx"]." order by gridtur_turno desc limit 1"; 
