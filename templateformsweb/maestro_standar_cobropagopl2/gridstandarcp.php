<?php
$this->formulario_path='artrofix/templateformsweb/maestro_standar_cobropagopl2/';
//--------------------------------------------------
...
function busca_doccompra()
{
 ...
 $("#divBody_buscacompradoc").load("templateformsweb/maestro_standar_cobropagopl2/buscacompra.php",{
...
function busca_docventa()
{
 ...
 $("#divBody_buscacompradoc").load("templateformsweb/maestro_standar_cobropagopl2/buscaventa.php",{
...
{
	 $("#divBody_calculos").load("templateformsweb/maestro_standar_cobropagopl2/caculos.php",{
