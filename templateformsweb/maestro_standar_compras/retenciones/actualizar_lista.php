...
{
   //echo $genra_listado[$i]["codigo"]."<br>";
   
   if ($genra_listado[$i]["codigo"]=='322')
   {
       //echo $genra_listado[$i]["base"]."<br>";
	   $nbase=0;
	   $nbase=0.1*$genra_listado[$i]["base"];
	   $genra_listado[$i]["base"]=$nbase;	   
	   $genra_listado[$i]["valor"]=round(($genra_listado[$i]["base"]*$genra_listado[$i]["porcentaje"])/100,2);   
