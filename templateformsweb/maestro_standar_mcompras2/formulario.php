...
function selecciona_p(valor)
{
  ...
  setTimeout(obtiene_prorrateo(), 1000);
...
$( "#cuadrobm_id" ).on( "change", function() {
    obtiene_prorrateo();
} );

function obtiene_prorrateo()
{

$("#obt_prorrateo").load("../../../../../templateformsweb/maestro_standar_mcompras2/obtprorrateo.php",{
        cuadrobm_id:$('#cuadrobm_id').val()
	  },function(result){  	
	
	  });  
	
$("#obt_prorrateo").html("Espere un momento..."); 
