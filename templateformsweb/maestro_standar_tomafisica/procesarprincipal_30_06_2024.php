...
$file = fopen("log/e_asiento".date("Y-m-d")."_".@$_SESSION['ces1313777_centro_id'].".txt", "a+");
fwrite($file,$_SESSION['ces1313777_sessid_inicio']."-->".$inserta_datas."-->".date("Y-m-d H:i:s"). PHP_EOL);
fclose($file);
...
$file = fopen("log/e_asiento".date("Y-m-d")."_".@$_SESSION['ces1313777_centro_id'].".txt", "a+");
fwrite($file,$_SESSION['ces1313777_sessid_inicio']."-->".$inserta_movimiento."-->".date("Y-m-d H:i:s"). PHP_EOL);
fclose($file);
