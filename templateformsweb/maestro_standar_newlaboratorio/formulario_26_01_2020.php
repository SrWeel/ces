...
<?php
			...
			$datos_centrodata="select * from dns_centrosalud inner join app_provincia on dns_centrosalud.prob_codigo=app_provincia.prob_codigo inner join app_canton on dns_centrosalud.cant_codigo=app_canton.cant_codigo where centro_id='".$_SESSION['ces1313777_centro_id']."'";
