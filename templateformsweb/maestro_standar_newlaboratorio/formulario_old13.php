...
<?php
			...
			//$objformulario->sendvar["serlab_idx"]=2;
			if($id_llega>0)
			{
...
<input type="button" name="btn_otroslab_id" id="btn_otroslab_id" value="MARCADORES TUMORALES"  onclick="ocultar_mostrarlab('otroslab_id')" />
