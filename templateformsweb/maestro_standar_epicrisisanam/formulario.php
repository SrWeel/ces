...
if($objformulario->contenid["anam_enlace"])
{
     $busca_diagx="select count(*) as total from cesdb_arextension.dns_epicrisisdiagnosticoanamnesisegreso where anam_enlace='".$objformulario->contenid["anam_enlace"]."'";
     $rs_diagx = $DB_gogess->executec($busca_diagx,array());     
	 $bandera_cie2=$rs_diagx->fields["total"];
}
else
{
     $busca_diagx="select count(*) as total from cesdb_arextension.dns_epicrisisdiagnosticoanamnesisegreso where anam_enlace='".$objformulario->sendvar["anam_enlacex"]."'";
     $rs_diagx = $DB_gogess->executec($busca_diagx,array());	 
	 $bandera_cie2=$rs_diagx->fields["total"];
}
