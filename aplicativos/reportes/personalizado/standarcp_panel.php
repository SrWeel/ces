...
<table width="500" border="1" align="center" cellpadding="0" cellspacing="0">
	<tr>
		...
		<td bgcolor="#E6F1F2" class="style1">TIPO</td>
	...
	<tr>
		...
		<select name="precu_activo" id="precu_activo" style="width:100px">
				<option value="">--seleccionar--</option>
				<?php
				$objformulario->fill_cmb("lpin_ttransac", "ttra_id,ttra_nombre", @$clie_id, " order by ttra_nombre asc", $DB_gogess);
				?>
			</select>
