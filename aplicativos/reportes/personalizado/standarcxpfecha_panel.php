...
function ejecuta_reporte()
{
 ...
 $("#ver_reporte").load("lospinos/listastandar_cxpfecha.php",{
...
function ver_excel()
{
 ...
 // alert("seleccione el rango de fecha");
  ...
  location.href = "lospinos/listastandar_cxpfecha.php?cliente_ruc="+$('#cliente_ruc').val()+"&centro_id="+$('#centro_id').val()+"&fecha_inicio="+$('#fecha_inicio').val()+"&fecha_fin="+$('#fecha_fin').val()+"&previsual=2&clie_institucionval="+$('#clie_institucionval').val()+"&ireport=<?php echo $ireport; ?>";
...
function ver_pdf()
{
 ...
 if($('#fecha_inicio').val()=='' && $('#fecha_fin').val()=='')
 {
  ...
  //return false;
   ...
   window.open("lospinos/listastandar_cxpfecha.php?cliente_ruc="+$('#cliente_ruc').val()+"&centro_id="+$('#centro_id').val()+"&fecha_inicio="+$('#fecha_inicio').val()+"&fecha_fin="+$('#fecha_fin').val()+"&previsual=3&clie_institucionval="+$('#clie_institucionval').val()+"&ireport=<?php echo $ireport; ?>", '_blank');  
