...
<SCRIPT LANGUAGE=javascript>
	...
	function ejecuta_reporte() {
		...
		$("#ver_reporte").load("lospinos/listastandar_compras.php", {
...
<table width="500" border="1" align="center" cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<input name="centro_id" type="hidden" id="centro_id" value="19" />
			
		<!-- <select name="centro_id" id="centro_id" style="width:200px" class="js-basic-single1 form-control">
		...
		<td><input name="fecha_inicio" type="text" id="fecha_inicio" class="form-control" autocomplete="off" ></td>
		<td><input name="fecha_fin" type="text" id="fecha_fin" class="form-control" autocomplete="off" ></td>
...
<script type="text/javascript">
	...
	function ver_pdf() {
		...
		window.open("lospinos/listastandar_compras.php?usua_id=" + $('#usua_id').val() + "&precu_facturar=" + $('#precu_facturar').val() + "&precu_activo=" + $('#precu_activo').val() + "&convepr_id=" + $('#convepr_id').val() + "&categesp_id=" + $('#categesp_id').val() + "&especipr_id=" + $('#especipr_id').val() + "&clie_id=" + $('#clie_id').val() + "&centro_id=" + $('#centro_id').val() + "&fecha_inicio=" + $('#fecha_inicio').val() + "&fecha_fin=" + $('#fecha_fin').val() + "&previsual=3&clie_institucionval=" + $('#clie_institucionval').val() + "&ireport=<?php echo $ireport; ?>", '_blank');
