...
<br>';
  ...
  $lista_doc = "select distinct comcont_id,comcont_tabla,comcont_idtabla from lpin_comprobantecontable inner join lpin_detallecomprobantecontable on lpin_comprobantecontable.comcont_enlace=lpin_detallecomprobantecontable.comcont_enlace  where comcont_anulado=0 and detcc_cuentacontable='' and year(comcont_fecha)='2023'";
