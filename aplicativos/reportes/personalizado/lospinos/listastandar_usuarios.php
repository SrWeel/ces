...
<br>';
  ...
  if ($concatena_sql) {
    $lista_doc = "SELECT app_usuario.usua_id,usua_ciruc,usua_codigoiniciales,usua_nombre,usua_apellido,usua_genero,usua_celular,usua_direcciondom,usua_telefonodom,usua_usuario,usua_email,usua_fechanacimiento,prof_nombre,civil_id FROM app_usuario left join dns_gridfuncionprofesional on app_usuario.usua_enlace=dns_gridfuncionprofesional.usua_enlace left join cesdb_arextension.dns_profesion on dns_gridfuncionprofesional.prof_id=cesdb_arextension.dns_profesion.prof_id where " . $concatena_sql;
  } else {
    $lista_doc = "SELECT app_usuario.usua_id,usua_ciruc,usua_codigoiniciales,usua_nombre,usua_apellido,usua_genero,usua_celular,usua_direcciondom,usua_telefonodom,usua_usuario,usua_email,usua_fechanacimiento,prof_nombre,civil_id FROM app_usuario left join dns_gridfuncionprofesional on app_usuario.usua_enlace=dns_gridfuncionprofesional.usua_enlace left join cesdb_arextension.dns_profesion on dns_gridfuncionprofesional.prof_id=cesdb_arextension.dns_profesion.prof_id order by usua_nombre asc";
  }
  ...
  if ($rs_data) {
    while (!$rs_data->EOF) {
      ...
      $nestado = $objformulario->replace_cmb("cesdb_arcombos.app_estadocivil", "civil_id,civil_nombre", " where civil_id =", $rs_data->fields["civil_id"], $DB_gogess);
