...
<br>';
  ...
  if ($rs_data) {
    while (!$rs_data->EOF) {
      ...
      $tipoc = '';
      $tipoc = $objformulario->replace_cmb("cesdb_arcombos.efacfactura_tipoidentificacion", "tipoident_codigo,tipoident_nombre", " where tipoident_codigo =", $rs_data->fields["tipoident_codigocl"], $DB_gogess);
      ...
      //DOCUMENTO
      $docu_cru = "select * from cesdb_arextension.lpin_crucedetalle where crudoc_enlace='" . $rs_data->fields["crudoc_enlace"] . "'";
      ...
      //ANTICIPOS
      $docu_cru = "select * from cesdb_arextension.lpin_cruceanticipos where crudoc_enlace='" . $rs_data->fields["crudoc_enlace"] . "'";
      ...
      if ($rs_crudetaanticipo) {
        while (!$rs_crudetaanticipo->EOF) {
          ...
          $busca_datosanti = "select * from app_anticipos left join cesdb_arcombos.cmb_tipomovantipo on app_anticipos.movantic_id=cesdb_arcombos.cmb_tipomovantipo.movantic_id
left join cesdb_arcombos.cmd_tipodetallemovanticipo on app_anticipos.detantic_id=cesdb_arcombos.cmd_tipodetallemovanticipo.detantic_id
...
inner join lpin_movanticipos on app_anticipos.anti_enlace=lpin_movanticipos.anti_enlace
      ...
      //CUENTA CONTABLE
      $docu_cru = "select * from cesdb_arextension.lpin_crucecuentas left join cesdb_aroriginal.app_proveedor on cesdb_arextension.lpin_crucecuentas.crucue_persona=cesdb_aroriginal.app_proveedor.provee_id where crudoc_enlace='" . $rs_data->fields["crudoc_enlace"] . "'";
