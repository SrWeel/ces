...
$rs_data = $DB_gogess->executec($lista_doc,array());
 if($rs_data)
 {
	 ...
	 $busca_paciente="select * from app_cliente left join cesdb_arextension.dns_tipoproceso on app_cliente.tippo_id=cesdb_arextension.dns_tipoproceso.tippo_id left join cesdb_arextension.dns_convenios on app_cliente.conve_id=cesdb_arextension.dns_convenios.conve_id where clie_id='".$rs_data->fields["clie_id"]."'";
