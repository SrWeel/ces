...
if($precu_activo)
  {
   $sql12=" lpin_cobropago.ttra_id='".$precu_activo."' and ";
  } 
        

$concatena_sql=$sql1.$sql2.$sql3.$sql4.$sql5.$sql6.$sql7.$sql8.$sql9.$sql10.$sql12;
...
$Nbunomcuenta=$objformulario->replace_cmb("lpin_plancuentas","planc_codigoc,planc_nombre"," where planc_codigoc like ",$rs_data->fields["cuentb_cuentacontable"],$DB_gogess);
...
$documento.='<td  style=mso-number-format:"@" >'.$Nbunomcuenta.'</td>';
