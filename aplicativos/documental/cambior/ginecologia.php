...
if(@$rs_acpaciente)
{
   //REVISION ACTUAL DE ORGANOS Y SISTEMAS (RAS)
    ...
    $busca_organos="update cesdb_arextension.dns_ginecologiagridorgano set gorgano_fecharegistro='".$nueva_fecha."' where anam_enlace='".$anam_enlace."' and gorgano_fecharegistro like '".$busca_fechareg[0]."%'";
    $rs_organos = $DB_gogess->executec($busca_organos,array());
   //REVISION ACTUAL DE ORGANOS Y SISTEMAS (RAS)
   
   //cesdb_arextension.dns_ginecologiagridexamenfisico   
    $busca_organos="update cesdb_arextension.dns_ginecologiagridexamenfisico set gexamfis_fecharegistro='".$nueva_fecha."' where anam_enlace='".$anam_enlace."' and gexamfis_fecharegistro like '".$busca_fechareg[0]."%'";
    $rs_organos = $DB_gogess->executec($busca_organos,array());   
   //cesdb_arextension.dns_ginecologiagridexamenfisico
  ...
  //borra permisos anteriores
   ...
   $inserta_rastro="insert into cesdb_arextension.dns_cambiofecharegistro (cbfech_tabla,cbfech_idvalor,cbfech_fecharegistroanterior,cbfech_fecharegistronueva,cbfech_motivo,cbfech_fechacambio,usua_id) values ('dns_ginecologiaanamesis','".$id_valor."','".$fecha_anterior."','".$nueva_fecha."','".$ttext_motivo."','".date("Y-m-d H:i:s")."','".$_SESSION['ces1313777_sessid_inicio']."')";
