...
{
  $lista_tituloformulario="select * from cesdb_arextension.dns_tipoformulario where tipofor_id=?";
...
<?php
$linkapaciente="onClick=ver_formularioenpantalla('aplicativos/documental/opciones/panel/panel_stnnewsalarecuperacionanamnesis.php','Editar','divBody_ext','','".@$clie_id."','231','".$atenc_id."',0,'".$tipofor_id."','".$centro_id."');";
...
$linksubsecuente="onClick=ver_formularioenpantalla('aplicativos/documental/opciones/panel/panel_stnnewsalarecuperacionsubsecuente.php','Perfil','divBody_ext','',".$clie_id.",'232',".$atenc_id.",0,'".$tipofor_id."',".$centro_id.");";
...
function  abre_formulariosecundario()
{
  if($('#<?php echo $campo_primario; ?>').val()>0)
   {
     ver_formularioenpantalla('aplicativos/documental/opciones/panel/panel_stnnewsalarecuperacionsubsecuente.php','SECUNDARIO','divBody_ext',0,'<?php echo @$clie_id; ?>','232','<?php echo $atenc_id; ?>','<?php echo $tipofor_id; ?>',$('#<?php echo $campo_primario; ?>').val(),'<?php echo $centro_id; ?>');
...
function genera_pdf()
{
  if($('#<?php echo $campo_primariodata; ?>').val()>0)
	 {	 
	    location.href = "pdfformularios/pdformularionewsalarecuperacion.php?ssr=<?php echo $campos_data64."|" ?>"+$('#<?php echo $campo_primariodata; ?>').val();
	 }
	 else
	 {
       alert("Por favor guarde el resgistro para imprimir");	 
