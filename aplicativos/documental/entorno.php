...
$rs_usuarios = $DB_gogess->executec($busca_datosus,array(@$_SESSION['ces1313777_sessid_inicio']));
$imagen_avatar='';
        ...
        <div id="hoeapp-container" hoe-color-type="lpanel-bg2" hoe-lpanel-effect="shrink">
            <aside id="hoe-left-panel" hoe-position-type="absolute">
                <div class="profile-box">
                    <div class="media">
                        <a class="pull-left" href="javascript:ver_formularioenpantalla('aplicativos/documental/datos_usuario.php','Perfil','divBody_ext','<?php echo $_SESSION['ces1313777_sessid_inicio'] ?>',0,0,0,0,0,0)">
                ...
                <ul class="nav panel-list">
					...
					<?php
					if($_SESSION['ces1313777_sessid_inicio']==75)
					{
					?>
					<li><a href="javascript:ver_formularioenpantalla('aplicativos/documental/opciones/panel/planillas_code.php','Perfil','divBody_ext','74','28',0,0,0,0,0)">
<img src="archivo/gogess_data95047DMGJS20190318.png" width="20" height="20"><span class="menu-text">Planillaje</span>
<span class="selected"></span>
					...
					//cliente
					//--------------------------------
					$lista_menu="select * from gogess_menupanel where mnupan_activo=1 and posp_id=1 and mnupan_id in (SELECT per_codobj FROM app_usuariosperfil WHERE per_activo=1 and usua_id=".@$_SESSION['ces1313777_sessid_inicio'].") order by 	mnupan_nombre asc ";
										...
										case 1:
										   {
											...
											echo '<a href="javascript:ver_formularioenpantalla(\'aplicativos/documental/opciones/panel/'.$rs_listamenu->fields["mnupan_archivo"].'\',\'Perfil\',\'divBody_ext\',\''.$_SESSION['ces1313777_sessid_inicio'].'\',\''.$rs_listamenu->fields["mnupan_id"].'\',0,0,0,0,0)" >
												'.$icon_val.'
												<span class="menu-text" >'.$rs_listamenu->fields["mnupan_nombre"].'</span>
												<span class="selected"></span>
											</a>';
											}
											break;
