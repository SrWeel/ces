...
<button type="button" class="mb-sm btn btn-success" onclick="ver_formularioenpantalla('aplicativos/documental/opciones/panel/panel_stnnewsalarecuperacionsubsecuente.php','Perfil','divBody_ext',0,'<?php echo @$clie_id; ?>','232','<?php echo $atenc_id; ?>','<?php echo $tipofor_id; ?>','<?php echo $anam_id; ?>','<?php echo $centro_id; ?>')" style="cursor:pointer"><span class="glyphicon glyphicon-arrow-left"></span> Regresar </button>
...
function imprimir_datosan()
{
   ...
   myWindow3=window.open('aplicativos/documental/datos_substandarformunico_print.php?iddata=605&pVar2=<?php echo @$clie_id; ?>&pVar4=<?php echo $atenc_id; ?>&pVar5=0&pVar3=-principal-&pVar9=<?php echo $anam_id; ?>','ventana_reporteunico','width=850,height=700,scrollbars=YES');
