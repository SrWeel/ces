    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <button type="button" class="mb-sm btn btn-success"
                    onclick="ver_formularioenpantalla('aplicativos/documental/opciones/panel/panel_stnnewtraumatologiasubsecuente.php','Perfil','divBody_ext',0,'<?php echo @$clie_id; ?>','202','<?php echo $atenc_id; ?>','<?php echo $tipofor_id; ?>','<?php echo $anam_id; ?>','<?php echo $centro_id; ?>')"
            ...
            <div class="form-group">
                ...
                <div class="col-xs-<?php echo $columna_css; ?>">
                    ...
                    <div class="alert alert-info" role="alert">
                        <p><b>Nota importante!</b>
                            Por favor no olvide guardar el registro cuando termine de ingresar datos, si no lo hace los
                            datos se perder&aacute;n</p>
                    </div>
