...
for($i=0;$i<count($array_haber);$i++)
		 {
		   ...
		   //BUSCA CUENTA
		     ...
		     $lista_data="INSERT INTO lpin_detallecomprobantecontable (detcc_id, detcc_cuentacontable, detcc_descricpion, detcc_referencia, detcc_entidad, detcc_debe, detcc_haber, usua_id, detcc_fecharegistro,comcont_enlace) VALUES (NULL, '".$detcc_cuentacontable."', '".$detcc_descricpion."', '".$detcc_referencia."', '','".$detcc_debe."','".$detcc_haber."','".$_SESSION['ces1313777_sessid_inicio']."', '".$doccab_retfechaemision."','".$comcont_enlace."') ";
...
( 5, '".$doccab_retfechaemision."', '".$concepto."', '".$doccab_retnumdoc."', 'APROBADO', 0, '".$comcont_enlace."', '".$_SESSION['ces1313777_sessid_inicio']."', '".$fecha_hoy."','".$_SESSION['ces1313777_centro_id']."', '".$tabla_asiento."', '".$valor_id."','AUTOMATICO');";
