...
$busca_listabrrado="select crucue_id from lpin_crucedocumentos inner join cesdb_arextension.lpin_crucecuentas on lpin_crucedocumentos.crudoc_enlace=cesdb_arextension.lpin_crucecuentas.crudoc_enlace where crudoc_id='".$crudoc_id."'";
...
$busca_cobros="select * from lpin_crucedocumentos inner join cesdb_arextension.lpin_crucecuentas on lpin_crucedocumentos.crudoc_enlace=cesdb_arextension.lpin_crucecuentas.crudoc_enlace inner join lpin_ttransac on lpin_crucedocumentos.crudoc_tipotransaccion=lpin_ttransac.ttra_id where crudoc_id='".$crudoc_id."'";
...
( '7', '".$crudoc_fechaemision."', '".$concepto."', '".$doccab_ndocumento."', 'APROBADO', 0, '".$comcont_enlace."', '".$_SESSION['ces1313777_sessid_inicio']."', '".$fecha_hoy."','".$_SESSION['ces1313777_centro_id']."', '".$tabla_asiento."', '".$valor_id."','AUTOMATICO','".$doccab_anulado."','beko_documentocabecera','".$rs_bcobros->fields["crudoc_ndocumentoventa"]."','".$crucue_id."');";
