...
$busca_cabeceraasiento="delete from lpin_comprobantecontable where comcont_tabla='".$tabla_asiento."' and comcont_idtabla='".$valor_id."' and tipoa_id='8' and comcont_tablas='beko_documentocabecera' and comcont_idtablas='".$rs_bcobros->fields["doccabcp_id"]."' and crpadet_id='".$rs_bcobros->fields["crpadet_id"]."'";
...
$busca_cabeceraasiento="select * from lpin_comprobantecontable where comcont_tabla='".$tabla_asiento."' and comcont_idtabla='".$valor_id."' and tipoa_id='8' and comcont_tablas='beko_documentocabecera' and comcont_idtablas='".$rs_bcobros->fields["doccabcp_id"]."' and crpadet_id='".$rs_bcobros->fields["crpadet_id"]."'";
$rs_bcabecera = $DB_gogess->executec($busca_cabeceraasiento);
...
$concepto='';
$concepto='EGR. DEV-PAGO '.$doccab_ndocumento.' '.$doccab_nombrerazon_cliente.' '.$doccab_apellidorazon_cliente;
//$concepto=$concepto;
//concepto factura
//++++++++++++++++++++++++++
...
for($i=0;$i<count($array_haber);$i++)
		 {
		  ...
		  $lista_data="INSERT INTO lpin_detallecomprobantecontable (detcc_id, detcc_cuentacontable, detcc_descricpion, detcc_referencia, detcc_entidad, detcc_debe, detcc_haber, usua_id, detcc_fecharegistro,comcont_enlace,detcc_tipo) VALUES (NULL, '".$detcc_cuentacontable."', '".$detcc_descricpion."', '".$detcc_referencia."', '','".round($detcc_debe,2)."','".round($detcc_haber,2)."','".$_SESSION['ces1313777_sessid_inicio']."', '".$doccab_fechaemision_cliente."','".$comcont_enlace."','".$detcc_tipo."') ";
...
( '8', '".$crb_fecha."', '".$concepto."', '".$doccab_ndocumento."', 'APROBADO', 0, '".$comcont_enlace."', '".$_SESSION['ces1313777_sessid_inicio']."', '".$fecha_hoy."','".$_SESSION['ces1313777_centro_id']."', '".$tabla_asiento."', '".$valor_id."','AUTOMATICO','".$doccab_anulado."','beko_documentocabecera','".$rs_bcobros->fields["doccabcp_id"]."','".$crpadet_id."');";
