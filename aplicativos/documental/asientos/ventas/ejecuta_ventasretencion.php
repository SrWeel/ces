...
//$doccab_anulado=$rs_dattos->fields["doccab_anulado"];
 ...
 if($doccab_retfechaemision=='' || $doccab_retfechaemision=='0000-00-00')
		 {
		      $doccab_retfechaemision=$doccab_fechaemision_cliente;
			  //$sindt='*****';			  
		 }
...
$actualiza_data="update lpin_comprobantecontable set comcont_anulado='".$doccab_anulado."',comcont_fecha='".$doccab_retfechaemision."',comcont_concepto='".$concepto."',comcont_numeroc='".$doccab_ndocumento."' where comcont_id='".$rs_bcabecera->fields["comcont_id"]."'";
...
( 5, '".$doccab_retfechaemision."', '".$concepto."', '".$doccab_ndocumento."', 'APROBADO', 0, '".$comcont_enlace."', '".$_SESSION['ces1313777_sessid_inicio']."', '".$fecha_hoy."','".$_SESSION['ces1313777_centro_id']."', '".$tabla_asiento."', '".$valor_id."','AUTOMATICO','".$doccab_anulado."');";
