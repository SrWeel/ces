...
/////////////////////////////////////PARA SOLUCIONAR EL PROBLEMA DR //////
// CARGAR REGISTRO PARA EDICIÓN
/*if (isset($_POST["pVar1"]) && $_POST["pVar1"] > 0) {

    $_REQUEST["opcion_".$table] = "buscar";
    $_REQUEST[$campo_primariodata] = $_POST["pVar1"];

}*/
// CARGAR REGISTRO PARA EDICIÓN (FORMA CORRECTA GO/GOGESS)
$csearch = 0;

if (isset($_POST["pVar1"]) && is_numeric($_POST["pVar1"]) && $_POST["pVar1"] > 0) {

    $csearch = (int)$_POST["pVar1"];
    $_REQUEST["opcion_".$table] = "buscar";
    $_REQUEST[$campo_primariodata] = $csearch;
...
<button type="button" class="mb-sm btn btn-success" onclick="ver_formularioenpantalla('aplicativos/documental/opciones/panel/panel_encuesta.php','Perfil','divBody_ext',0,'<?php echo $_POST["pVar2"]; ?>',0,0,0,0,0)" style="cursor:pointer"><span class="glyphicon glyphicon-arrow-left"></span> Regresar </button>
...
&nbsp;&nbsp;&nbsp;<button type="button" class="mb-sm btn btn-primary" onclick="ver_formularioenpantalla('aplicativos/documental/datos_encuesta.php','TARIFARIO','divBody_ext',0,'<?php echo $mnupan_id; ?>',0,0,0,0,0)" style="cursor:pointer"><span class="glyphicon glyphicon-plus"></span>NUEVO REGISTRO</button>
...
<?php		
		...
		//////////////////////////
/*		echo "<pre>";
echo "POST pVar1: "; var_dump($_POST["pVar1"]);
echo "REQUEST PK: "; var_dump($_REQUEST[$campo_primariodata]);
echo "csearch: "; var_dump($csearch);
echo "</pre>";
exit;
*/

// FORZAR ID REAL PARA TABLAS.PHP (CRÍTICO)
if (isset($csearch) && $csearch > 0) {
    $_REQUEST["pVar1"] = $csearch;
    $_POST["pVar1"]    = $csearch;
    $variableb         = $csearch;
}
