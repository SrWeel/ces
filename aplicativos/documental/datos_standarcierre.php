...
$busca_cfgdata="select cgfe_tiempoactivocierre from efacsistema_cfgempresa where emp_id='".$_SESSION['ces1313777_sessid_emp_id']."'";
...
<button type="button" class="mb-sm btn btn-success" onclick="ver_formularioenpantalla('aplicativos/documental/opciones/panel/panel_standarcierre.php','Perfil','divBody_ext',0,'<?php echo $_POST["pVar2"]; ?>',0,0,0,0,0)" style="cursor:pointer"><span class="glyphicon glyphicon-arrow-left"></span> Regresar </button>
...
function imprimir_datos()
{
  ...
  if($('#<?php echo $campo_primariodata; ?>').val()>0)
	 {
   myWindow3=window.open('aplicativos/documental/datos_substandarprintcierre_print.php?iddata=<?php echo $tab_id ?>&pVar2=&pVar4=&pVar5='+$('#<?php echo $campo_primariodata; ?>').val()+'&pVar3=<?php echo $mnupan_id; ?>','ventana_reporteunico','width=850,height=700,scrollbars=YES');
