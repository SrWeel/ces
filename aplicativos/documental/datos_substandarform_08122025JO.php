...
echo '<button type="button" class="mb-sm btn btn-info" '.$linkimprimir.'  style="cursor:pointer"><span class="glyphicon glyphicon-print"></span>DRDRDRDRDR</button>&nbsp;&nbsp;';
//////
...
function genera_pdfevolucion()
{
	    ...
	    location.href = "pdfformularios/pdfformenfermeria.php?ssr=<?php echo $campos_data64."|" ?>"+"<?php echo $anam_id; ?>";
