...
if($('#permi_id').val()=='')
{
   ...
   myWindow3=window.open('reportes/reportes_permiso.php?idsec='+$('#permi_id').val()+'&pVar2=<?php echo @$_SESSION['ces1313777_sessid_inicio']; ?>','ventana_evolucion','width=850,height=700,scrollbars=YES');
