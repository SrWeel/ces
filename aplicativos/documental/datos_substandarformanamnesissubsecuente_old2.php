...
<?php
$lista_turnos="select gridtur_id from dns_gridturnos inner join dns_atencion on dns_gridturnos.atenc_enlace=dns_atencion.atenc_enlace where especi_id=".$rs_datosmenu->fields["especi_id"]." and gridtur_fecha='".date("Y-m-d")."' and dns_atencion.centro_id=".$_SESSION['ces1313777_centro_id']." and gridtur_estado='' limit 1";
$lista_turnos="";
