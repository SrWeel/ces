<script type="text/javascript">
    ...
    function ingreso_usuario_ac(funciones_siguientes) {
        ...
        $("#acceso_usuario_ac").load("libreria/acceso/validar_ac.php", {
            ...
            accesousuario: '<?php echo $accesousuario ?>',
            usuario_valor_ac: $('#usuario_valor_ac').val(),
            clave_valor_ac: $('#clave_valor_ac').val(),
            punto_id: $('#punto_id').val(),
            tipo_ing: $('#tipo_ing').val(),
    ...
    function ingreso_usuario() {
        ...
        $("#acceso_usuario").load("libreria/acceso/validar.php", {
            ...
            accesousuario: '<?php echo $accesousuario ?>',
            usuario_valor: $('#usuario_valor').val(),
...
<script type="text/javascript">
    ...
    function enviar_formulario(table) {
        ...
        $("#" + table).submit();
        $("#verifica_sess").load("aplicativos/documental/verifica_sess.php", {}, function(result) {});
        $("#verifica_sess").html("");
