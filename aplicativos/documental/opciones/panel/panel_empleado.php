...
function desplegar_grid(tipo)
{
  ...
  todos:tipo,
  ci_medico:'<?php echo $_SESSION['ces1313777_sessid_inicio']; ?>',
...
else
{
 message = $("<span class='success' >Por favor seleccione un archivo.</span>");
                ...
                if(isImage(fileExtension))
                {
					...
					$(".showImage"+ncampo).html("&nbsp;<a href='archivo/"+data+"' target='_blank' class='thumbnail' ><img src='images/pdf2.png' alt='125x125' width='50px' ></a>");
...
<div class="panel panel-default">
 <div class="panel-heading">
    <h3 class="panel-title" style="color:#000033" >FICHA DE PERSONAL</h3>
...
<table border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td><strong>CEDULA / NOMBRE: </strong></td>

    <td><input name="busca_valorci" type="text" id="busca_valorci" size="50" /></td>

    <td><input type="button" name="Button" value="BUSCAR" onclick="desplegar_grid(0)" /></td>
