...
<table width="100%" border="1" cellpadding="0" cellspacing="0">
	<tr>
		...
		<?php
		//if($_SESSION['ces1313777_sessid_inicio']=='2')
		//{
		?>
		<td bgcolor="#CCCCCC" class="css_titulo">
	...
	?>
			...
			?>
				<tr>
					...
					<?php
					if ($_SESSION['ces1313777_sessid_inicio'] == '2' || $_SESSION['ces1313777_sessid_inicio'] == '427' || $_SESSION['ces1313777_sessid_inicio'] == '510'  || $_SESSION['ces1313777_sessid_inicio'] == '501') {
					?><td>
							<input type="submit" name="Submit2" value="Corregir Precio" onclick="corregir_preciox('<?php echo $precu_id; ?>','<?php echo $rs_lprecuentas->fields["detapre_id"]; ?>')" />
						</td>
					<?php
