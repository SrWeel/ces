...
$comillasimple="'";
$subindice='_stnnewsalarecuperacionsubsecuente';
$carpeta='stnnewsalarecuperacionsubsecuente';
...
$comill_s="'";
$linkeditar= 'onClick="ver_formularioenpantalla('.$comill_s.'aplicativos/documental/datos_stnnewsalarecuperacionsubsecuente.php'.$comill_s.','.$comill_s.'MEDICOS'.$comill_s.','.$comill_s.'divBody_ext'.$comill_s.','.$comill_s.$comill_s.','.$comill_s.@$clie_id.$comill_s.','.$comill_s.$mnupan_id.$comill_s.','.$comill_s.$atenc_id.$comill_s.','.$comill_s.$tipofor_id.$comill_s.','.$comill_s.$anam_id.$comill_s.','.$comill_s.$centro_id.$comill_s.')" style=cursor:pointer';	


$linkapaciente="onClick=ver_formularioenpantalla('aplicativos/documental/datos_stnnewsalarecuperacionanamnesis.php','Editar','divBody_ext','".$anam_id."','".@$clie_id."',231,'".$atenc_id."',0,'".$tipofor_id."','".$centro_id."');";
...
function genera_pdfevolucion()
{
	    ...
	    location.href = "pdfformularios/pdfformevolucionnewsalarecuperacion.php?ssr=<?php echo $campos_data64."|" ?>"+"<?php echo $anam_id; ?>";
