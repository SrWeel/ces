...
function ejecuta_despachar(cuadrobm_id,centro_id,maximop,clie_id)
{
  ...
  abrir_standar("aplicativos/documental/opciones/panel/pedidoabodega/lotes.php","Despacho","divBody_pdespacho","divDialog_pdespacho",580,500,<?php echo $precu_id; ?>,'dns_precuenta',centro_id,'<?php echo $_SESSION['ces1313777_sessid_inicio']; ?>','<?php echo $clie_id; ?>',maximop,cuadrobm_id);
