...
echo '&nbsp;&nbsp;&nbsp;<a href="aplicativos/reportes/personalizado/panel.php?ireport=62" target="_blank" class="mb-sm btn btn-primary" style="background-color:#000066"><span class="glyphicon glyphicon-plus"></span>LISTA PACIENTES POR MEDICO CON FACTURAS</a>';

echo '&nbsp;&nbsp;&nbsp;<a href="aplicativos/reportes/personalizado/panel.php?ireport=68" target="_blank" class="mb-sm btn btn-primary" style="background-color:#000066"><span class="glyphicon glyphicon-plus"></span>LISTA PACIENTES POR MEDICO CON ESPECIALIDAD</a>';

echo '<br><br><button type="button" class="mb-sm btn btn-success" onClick="desplegar_grid(1)"  style="cursor:pointer"> MIS PACIENTES </button>';
...
echo '<p>&nbsp;</p><div class="form-group"><label class="control-label col-xs-3">M&eacute;dico: <span style="font-family:Arial, Helvetica, sans-serif; font-size:12px; color:#FF0000;">*</span></label>
...
echo '</select></div>
<div class="col-xs-1">
<button type="button" class="mb-sm btn btn-success" onClick="desplegar_grid(3)"  style="cursor:pointer"> LISTAR </button>
</div>
</div>';
