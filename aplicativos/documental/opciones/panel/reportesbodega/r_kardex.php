...
<div align="center">
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td><div align="center"><strong>LOS PINOS</strong></div></td>
    </tr>
    <tr>
                   ...
                   if($rs_listakardex)
				   {
					...
					?>
					 <tr>
						...
						<td <?php echo $clickverl; ?> style="color:#0033CC; cursor:pointer" ><?php echo $compra_nsec.' '.$data_ajus; ?></td>
					...
					<tr <?php echo $color; ?> >
					   <td><?php $cuentav++;
						...
						<td <?php echo $clickverl; ?> style="color:#0033CC; cursor:pointer" ><?php echo $compra_nseceg.' '.$data_ajus; ?></td>
						
						<td><?php echo utf8_encode($rs_listakardex->fields["bodega"].$nmovi.$rs_listakardex->fields["tipomov_id"]); ?></td>
						<td><?php echo utf8_encode($rs_cdor->fields["centro_nombre"])." ".$datsospaciente; ?></td>
