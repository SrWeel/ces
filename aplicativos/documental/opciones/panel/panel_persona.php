...
echo '&nbsp; &nbsp; &nbsp; &nbsp; <a href="aplicativos/reportes/personalizado/panel.php?ireport=57" target="_blank" class="mb-sm btn btn-primary" style="background-color:#000066"><span class="glyphicon glyphicon-plus"></span>REPORTE EN EXCEL PROVEEDORES</a> ';

echo '&nbsp; &nbsp; &nbsp; &nbsp; <a href="aplicativos/reportes/personalizado/panel.php?ireport=67" target="_blank" class="mb-sm btn btn-primary" style="background-color:#000066"><span class="glyphicon glyphicon-plus"></span>REPORTE EN EXCEL CLIENTES</a> ';
