...
<table width="600" border="0" align="center" cellpadding="0" cellspacing="0" >
  <tr>
	...
	<div align="center">
	<button type="button" class="mb-sm btn btn-primary" onclick="ver_informedns(11,'')"   style="background-color:#000066"   >LISTA USUARIOS</button>
	</div>
...
myWindow2=window.open('reportes/certificado_standarusuario.php?seccion='+seccion+'&idsec='+id+'&dhoja='+reponsables,'ventana_consentimiento','width=950,height=600,scrollbars=YES');
myWindow2.focus();
