...
if($rs_bprecuenta)
 {
	...
	$lista_convenio="select * from cesdb_arextension.dns_convenios where 	conve_id='".$convepr_id."'";
...
<div align="right"><br>
<?php
if($usua_permitepedido==1 or $_SESSION['ces1313777_sessid_inicio']==546 or $_SESSION['ces1313777_sessid_inicio']==284 or $_SESSION['ces1313777_sessid_inicio']==295  or $_SESSION['ces1313777_sessid_inicio']==515)
{
?>
...
function ejecuta_despachar(cuadrobm_id,centro_id,maximop,clie_id)
{
  ...
  abrir_standar("aplicativos/documental/opciones/panel/pedidoabodegav3/lotes.php","Despacho","divBody_pdespacho","divDialog_pdespacho",580,500,'<?php echo $precu_id; ?>','dns_precuenta',centro_id,'<?php echo $_SESSION['ces1313777_sessid_inicio']; ?>','<?php echo $clie_id; ?>',maximop,cuadrobm_id);
