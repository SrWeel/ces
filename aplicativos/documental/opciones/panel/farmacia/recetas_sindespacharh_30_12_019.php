...
<table width="550" border="1" cellpadding="0" cellspacing="0">
  ...
  if($rs_medi1)
 {
  ...
  <tr>
	...
	$busca_periso="select * from cesdb_arextension.dns_permisosdespacho where permid_tabla='".$tablareceta."' and permid_idtabla='".$rs_medi1->fields["plantra_id"]."' and DATE_ADD(permid_fecharegistro,INTERVAL 3 DAY)>=NOW()";
...
$rs_medi1 = $DB_gogess->executec($lista_medicametos,array());
  ...
  if($rs_medi1)
 {
  ...
  <tr>
	...
	$busca_periso="select * from cesdb_arextension.dns_permisosdespacho where permid_tabla='".$tablareceta."' and permid_idtabla='".$rs_medi1->fields["plantrai_id"]."' and DATE_ADD(permid_fecharegistro,INTERVAL 3 DAY)>=NOW()";
