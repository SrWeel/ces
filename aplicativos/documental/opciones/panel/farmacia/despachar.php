...
$busca_espcial="select permid_id from  cesdb_arextension.dns_permisosdespacho where 	permid_tabla='".$_POST["tabla"]."' and 	permid_idtabla='".$_POST["plantra_id"]."' and permid_motivo='INGRESO_ANTERIOR_SOPORTE_SISTEMA'";
