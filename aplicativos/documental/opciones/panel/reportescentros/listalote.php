...
?>
  <select name="lote_pr" id="lote_pr" style="font-size:11px; width:120px" >
          <?php
			  ...
			  $busca_lotes="SELECT distinct moviin_nlote from dns_movimientoinventario where centro_id='".$_SESSION['ces1313777_centro_id']."' and cuadrobm_id='".$rs_nmedic->fields["cuadrobm_id"]."' and perioac_id='".$per_activo."'";
