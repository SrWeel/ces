...
$linkeditar= 'onClick=ver_formularioenpantalla('.$comill_s.'aplicativos/documental/datos_stnnewsalarecuperacionanamnesis.php'.$comill_s.','.$comill_s.'MEDICOS'.$comill_s.','.$comill_s.'divBody_ext'.$comill_s.','.$comill_s.$comill_s.','.$comill_s.@$clie_id.$comill_s.','.$comill_s.$mnupan_id.$comill_s.','.$comill_s.$atenc_id.$comill_s.','.$comill_s.$eteneva_id.$comill_s.','.$comill_s.$tipofor_id.$comill_s.','.$comill_s.$centro_id.$comill_s.')';	
