   ...
   $centrob_idvalida=$rs_lprecuentas->fields["centrob_id"];
    ...
    <tr>
       <td height="21" class="css_texto"><div align="center">
		 ...
		 {
		    if($_SESSION['ces1313777_sessid_inicio']==515 or $_SESSION['ces1313777_sessid_inicio']==2 or $_SESSION['ces1313777_sessid_inicio']==295 or $_SESSION['ces1313777_sessid_inicio']==284)
		    {
		 ?>
