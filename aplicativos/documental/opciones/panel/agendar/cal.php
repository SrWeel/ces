	...
	<tr bgcolor="silver">
		...
		for($i=1;$i<=42;$i++)
		{
			...
			if($i<$diaSemana || $i>=$last_cell)
			{
				...
				$link_agregar="abrir_standar('aplicativos/documental/opciones/panel/agendar/seleccion.php','PANTALLA','divBody_pantallag','divDialog_pantallag',600,590,'".$fecha_bu."','".$_POST["atenc_hc"]."','".$_POST["clie_id"]."','".@$_POST["centro_id"]."','".@$_SESSION['ces1313777_sessid_inicio']."',0,0); ";
