...
<table  width="98%" border="1" align="center" cellpadding="0" cellspacing="1" class="table-hover record_table" id="tabla"  >
  <tr>
    <td bgcolor="#DCF0F5">ZONA: <b><?php echo $rs_zona->fields["zona_nombre"]; ?></b> </td>
  </tr>
   <tr>
    <td>
  

  <table width="100%" border="1" align="center" cellpadding="0" cellspacing="1" class="table-hover record_table" id="tabla" >			  
			  <tr>
			  <td bgcolor="#AEDBE8"><strong>ID</strong></td>
			  <td nowrap="nowrap" bgcolor="#AEDBE8"><strong>Nombre</strong></td>
			  ...
			  <td bgcolor="#AEDBE8"><strong>Activar Movimientos en Centros (Medicamentos)</strong></td>
			  <td bgcolor="#AEDBE8"><strong>Activar Movimientos en Centros (Dispositivos)</strong></td>
			  </tr>	
			  <?php
