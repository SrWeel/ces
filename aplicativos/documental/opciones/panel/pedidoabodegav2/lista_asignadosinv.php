...
echo "<br>";
$lista_bprecuentac="select * from lpin_parteoperatorio left join cesdb_arextension.dns_convenios on lpin_parteoperatorio.convepr_id=cesdb_arextension.dns_convenios.conve_id where partop_id='".$partop_id."'";
