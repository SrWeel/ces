...
<div class="panel panel-default">
 <div class="panel-heading" style="background-color:#BAE0B6;" >
    <h3 class="panel-title" style="color:#000033" >PEDIDOS DE MEDICAMENTOS / INSUMOS VARIOS</h3>
 </div>
...
<div class="table-responsive" >
  <table width="400" border="0" align="center" cellpadding="0" cellspacing="0" class="display responsive cell-border" >
    ...
    <tr>
	 ...
	 C&Eacute;DULA:			</td>
            <td>
			<input name="ci_pacientepr" type="text" id="ci_pacientepr"  class="form-control"  />
