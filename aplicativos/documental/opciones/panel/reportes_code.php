...
if($rs_gogessform)
 {
    ...
    <td onclick="ver_reportedata('.$rs_gogessform->fields["vardev_id"].')" style="cursor:pointer" ><div class="css_dos">'.$rs_gogessform->fields["vardev_nombre"].'</div></td>
