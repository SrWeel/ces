...
$buespe='';
$buespe="select distinct us.usua_id from app_usuario us inner join dns_gridfuncionprofesional espe on us.usua_enlace=espe.usua_enlace inner join cesdb_arextension.dns_profesion prof on espe.prof_id=prof.prof_id where prof.prof_id='".$_POST["prof_idtx"]."' and prof.prof_id not in (38,777,888,911116,77)";
