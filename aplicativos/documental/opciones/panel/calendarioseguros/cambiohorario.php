...
<?php
//$objformulario->fill_cmb('app_usuario','usua_id,usua_nombre,usua_apellido',$rs_buscat->fields["usua_id"],' where prof_id='.$rs_buscat->fields["prof_id"].' and centro_id='.$_SESSION['ces1313777_centro_id'].'  order by usua_apellido asc',$DB_gogess);
