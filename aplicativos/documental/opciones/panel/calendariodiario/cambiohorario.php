...
if (@$_SESSION['ces1313777_sessid_inicio']) {
  ...
  $buespe = '';
  $buespe = "select distinct us.usua_id from app_usuario us inner join dns_gridfuncionprofesional espe on us.usua_enlace=espe.usua_enlace inner join cesdb_arextension.dns_profesion prof on espe.prof_id=prof.prof_id where prof.prof_id='" . $rs_buscat->fields["prof_id"] . "' and prof.prof_id not in (38,777,888,911116,77)";
?>
  <style type="text/css">
    <!--
    .css_cambiot {
  ...
  <table border="0" align="center" cellpadding="0" cellspacing="2">
    <tr>
      ...
      <td> <select name="prof_idcambio" id="prof_idcambio" class="form-control" onchange="ver_terapistacalcambio()">
          ...
          <?php
          $objformulario->fill_cmb('cesdb_arextension.dns_profesion', 'prof_id,prof_nombre', $rs_buscat->fields["prof_id"], $filtro_espe, $DB_gogess);
          ?>
        </select></td>
    </tr>
    <tr>
      ...
      <td>
        <div id="lista_terapistacalcambio">
          <select class="form-control" name="usua_idvalcambio" id="usua_idvalcambio" style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:10px">
            ...
            <?php
            //$objformulario->fill_cmb('app_usuario','usua_id,usua_nombre,usua_apellido',$rs_buscat->fields["usua_id"],' where especi_id='.$rs_buscat->fields["especi_id"].' and centro_id='.$_SESSION['ces1313777_centro_id'].'  order by usua_apellido asc',$DB_gogess);
    ...
    <tr>
      <td colspan="2">
        <div align="center" class="css_titulocambio"> REAGENDAMIENTO </div>
      </td>
    </tr>
    <tr>
