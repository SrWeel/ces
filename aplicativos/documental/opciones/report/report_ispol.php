...
$n_especialiddnm=0;
$n_especialiddnm=$objformulario->replace_cmb("cesdb_arextension.dns_profesion","prof_nombre,prof_id"," where prof_nombre like ",$rs_btarifario->fields["usua_formaciondelprofesional"],$DB_gogess); 
