...
//
//
//// DIAGNÓSTICO: Ver qué datos tiene
//echo "<h2>DIAGNÓSTICO DEL PACIENTE</h2>";
//echo "Cédula buscada: " . $_POST["clie_rucci"] . "<br>";
//
//if($rs_ATENCIOn) {
//    echo "Total atenciones encontradas: " . $rs_ATENCIOn->RecordCount() . "<br><br>";
//
//    while (!$rs_ATENCIOn->EOF) {
//        $clie_id = $rs_ATENCIOn->fields["clie_id"];
//        $atenc_id = $rs_ATENCIOn->fields["atenc_id"];
//
//        echo "<hr><b>ATENCIÓN ID: $atenc_id</b><br>";
//        echo "Cliente ID: $clie_id<br>";
//        echo "Fecha atención: " . $rs_ATENCIOn->fields["atenc_fecharegistro"] . "<br>";
//
//        // VERIFICA CADA TABLA
//        echo "<br><b>Verificando datos en tablas:</b><br>";
//
//        // 1. Consulta Externa Nueva
//        $check1 = "SELECT COUNT(*) as total FROM dns_newconsultaexternaanamesis WHERE atenc_id='$atenc_id'";
//        $rs_check1 = $DB_gogess->executec($check1, array());
//        echo "- dns_newconsultaexternaanamesis: " . $rs_check1->fields["total"] . " registros<br>";
//
//        // 2. Anamnesis Examen Físico
//        $check2 = "SELECT COUNT(*) as total FROM dns_anamesisexamenfisico WHERE atenc_id='$atenc_id'";
//        $rs_check2 = $DB_gogess->executec($check2, array());
//        echo "- dns_anamesisexamenfisico: " . $rs_check2->fields["total"] . " registros<br>";
//
//        // 3. Emergencia
//        $check3 = "SELECT COUNT(*) as total FROM dns_emergenciaanamesis WHERE atenc_id='$atenc_id'";
//        $rs_check3 = $DB_gogess->executec($check3, array());
//        echo "- dns_emergenciaanamesis: " . $rs_check3->fields["total"] . " registros<br>";
//
//        // 4. Gastroenterología
//        $check4 = "SELECT COUNT(*) as total FROM dns_gastroenterologiaanamesis WHERE atenc_id='$atenc_id'";
//        $rs_check4 = $DB_gogess->executec($check4, array());
//        echo "- dns_gastroenterologiaanamesis: " . $rs_check4->fields["total"] . " registros<br>";
//
//        // 5. Pediatría
//        $check5 = "SELECT COUNT(*) as total FROM dns_pediatriaanamesis WHERE atenc_id='$atenc_id'";
//        $rs_check5 = $DB_gogess->executec($check5, array());
//        echo "- dns_pediatriaanamesis: " . $rs_check5->fields["total"] . " registros<br>";
//
//        // 6. Traumatología
//        $check6 = "SELECT COUNT(*) as total FROM dns_traumatologiaanamesis WHERE atenc_id='$atenc_id'";
//        $rs_check6 = $DB_gogess->executec($check6, array());
//        echo "- dns_traumatologiaanamesis: " . $rs_check6->fields["total"] . " registros<br>";
//
//        // 7. Hospitalización
//        $check7 = "SELECT COUNT(*) as total FROM dns_newhospitalizacionanamesis WHERE atenc_id='$atenc_id'";
//        $rs_check7 = $DB_gogess->executec($check7, array());
//        echo "- dns_newhospitalizacionanamesis: " . $rs_check7->fields["total"] . " registros<br>";
//
//        // 8. Cardiología
//        $check8 = "SELECT COUNT(*) as total FROM dns_cardiologiaanamesis WHERE atenc_id='$atenc_id'";
//        $rs_check8 = $DB_gogess->executec($check8, array());
//        echo "- dns_cardiologiaanamesis: " . $rs_check8->fields["total"] . " registros<br>";
//
//        // 9. Ginecología
//        $check9 = "SELECT COUNT(*) as total FROM dns_ginecologiaanamesis WHERE atenc_id='$atenc_id'";
//        $rs_check9 = $DB_gogess->executec($check9, array());
//        echo "- dns_ginecologiaanamesis: " . $rs_check9->fields["total"] . " registros<br>";
//
//        // 10. Interconsulta
//        $check10 = "SELECT COUNT(*) as total FROM dns_interconsulta WHERE atenc_id='$atenc_id'";
//        $rs_check10 = $DB_gogess->executec($check10, array());
//        echo "- dns_interconsulta: " . $rs_check10->fields["total"] . " registros<br>";
//
//        // 11. Referencia
//        $check11 = "SELECT COUNT(*) as total FROM dns_referencia WHERE atenc_id='$atenc_id'";
//        $rs_check11 = $DB_gogess->executec($check11, array());
//        echo "- dns_referencia: " . $rs_check11->fields["total"] . " registros<br>";
//
//        // 12. Imagenología
//        $check12 = "SELECT COUNT(*) as total FROM dns_imagenologia WHERE atenc_id='$atenc_id'";
//        $rs_check12 = $DB_gogess->executec($check12, array());
//        echo "- dns_imagenologia: " . $rs_check12->fields["total"] . " registros<br>";
//
//        // 13. Nueva Imagenología
//        $check13 = "SELECT COUNT(*) as total FROM dns_newimagenologia WHERE atenc_id='$atenc_id'";
//        $rs_check13 = $DB_gogess->executec($check13, array());
//        echo "- dns_newimagenologia: " . $rs_check13->fields["total"] . " registros<br>";
//
//        // 14. Laboratorio
//        $check14 = "SELECT COUNT(*) as total FROM dns_laboratorio WHERE atenc_id='$atenc_id'";
//        $rs_check14 = $DB_gogess->executec($check14, array());
//        echo "- dns_laboratorio: " . $rs_check14->fields["total"] . " registros<br>";
//
//        // 15. Nuevo Laboratorio
//        $check15 = "SELECT COUNT(*) as total FROM dns_newlaboratorio WHERE atenc_id='$atenc_id'";
//        $rs_check15 = $DB_gogess->executec($check15, array());
//        echo "- dns_newlaboratorio: " . $rs_check15->fields["total"] . " registros<br>";
//
//        $rs_ATENCIOn->MoveNext();
//    }
//} else {
//    echo "NO SE ENCONTRARON ATENCIONES<br>";
//}
//
//echo "<hr><h2>FIN DEL DIAGNÓSTICO</h2>";
?>
<style type="text/css">
<!--
  ...
  <tr>  
	...
	if($rs_tabeval->fields["tab_name"]=='dns_anamesisexamenfisico')
		...
		if($rs_tabeval->fields["tab_name"]=='dns_emergenciaanamesis')
				...
				$lista_subsecuentes="select * from dns_protocolooperatorio where protoop_tblprincipal='dns_newhospitalizacionanamesis' and protoop_idenlace='".$rs_seccion->fields["anam_id"]."' order by protoop_fecharegistro desc";
				$rs_subsecuentes = $DB_gogess->executec($lista_subsecuentes,array());
				 if($rs_subsecuentes)
					{
						while (!$rs_subsecuentes->EOF) {
				...
				$lista_subsecuentes="select * from dns_epicrisisanamesis where protoop_tblprincipal='dns_newhospitalizacionanamesis' and protoop_idenlace='".$rs_seccion->fields["anam_id"]."' order by anam_fecharegistro desc";
				$rs_subsecuentes = $DB_gogess->executec($lista_subsecuentes,array());
				 if($rs_subsecuentes)
					{
						while (!$rs_subsecuentes->EOF) {
