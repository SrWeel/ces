...
echo '<button type="button" class="mb-sm btn btn-info" onclick="imprimir_plan();" style="cursor:pointer"><span class="glyphicon glyphicon-print"></span> IMPRIMIR PLAN DE CUENTAS</button>';

echo '&nbsp;&nbsp;&nbsp;<button type="button" class="mb-sm btn btn-primary" onclick="imprimir_planexcel();" style="cursor:pointer"><span class="glyphicon glyphicon-print"></span> IMPRIMIR PLAN DE CUENTAS EXCEL</button>';
