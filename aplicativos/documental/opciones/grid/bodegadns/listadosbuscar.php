...
-->
		  ...
		  <table border="1" align="center" cellpadding="0" cellspacing="1" id="tabla" class="table-hover record_table" >
			  ...
			  ?>
			  <td bgcolor="#AEDBE8"><strong>Nombre TF</strong></td>
			  <td bgcolor="#AEDBE8"><strong>Nombre</strong></td>
			  <td bgcolor="#AEDBE8"><strong>Stock Minimo Nacional</strong></td>
			  <td bgcolor="#AEDBE8"><strong>Stock Actual Bodega</strong></td>
			  <td bgcolor="#AEDBE8"><strong>Stock Actual Nacional Establecimientos de Salud</strong></td>
			  <td bgcolor="#AEDBE8"><strong>Stock Global</strong></td>
			  <?php
			  if($insu==1)
			  {
			  ?>
