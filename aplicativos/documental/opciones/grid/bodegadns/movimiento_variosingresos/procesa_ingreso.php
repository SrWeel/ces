...
$procesado_data="update dns_varioscompras set compra_procesado='1',compra_fechaprocesado='".date("Y-m-d H:i:s")."',compra_usprocesa='".$_SESSION['ces1313777_sessid_inicio']."' where compra_id='".$compra_id."';";
