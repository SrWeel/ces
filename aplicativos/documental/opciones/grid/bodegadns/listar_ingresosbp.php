...
//$_SESSION['ces1313777_centro_id']

$centro_idlocal=55;

?>
<br />
<center><b>ORIGEN DE CENTROS</b></center>
<br />
			  ...
			  <?php
				 ...
				 //echo $lista_campor;
                   ...
                   if($rs_listacmp)
				   {
                        ...
                        echo '<td>&nbsp;&nbsp;</td>';
						echo '<td><div id="rechazar_documento'.$rs_listacmp->fields["egrec_id"].'" ><input type="button" name="Submit" value="Rechazar Comprobante"  '.$clickrechazar.' /></div></td>';	
...
$("#rechazar_documento"+egrec_id).load("aplicativos/documental/opciones/grid/bodegadns/rechazar_doc.php",{
