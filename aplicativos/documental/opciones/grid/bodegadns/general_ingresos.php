...
<div align="center">
  <table border="0" cellpadding="0" cellspacing="0">
    <tr>
      ...
      <td><input type="button" name="Button" value="Nuevo Comprobante de Ingreso" onclick="abrir_standar('variosingresos/grid_ingresos_nuevo.php','Ingresos','divBody_producto','divDialog_producto',800,600,0,0,0,0,0,'<?php echo $bodega_principal; ?>','<?php echo $_GET["insu"]; ?>')" /></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
  </table>
...
function ingresos_prkprod(compra_id)
 {
    //alert(compra_id);
	 abrir_standar('movimiento_variosingresos/movimiento.php','Ingresos_<?php echo $nombre_lista; ?>','divBody<?php echo $subindice; ?>','divDialog<?php echo $subindice; ?>',990,700,0,compra_id,0,0,0,'<?php echo $bodega_principal; ?>','<?php echo $insu_valorx; ?>');
