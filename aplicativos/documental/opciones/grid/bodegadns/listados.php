...
-->
 ...
 <table width="972" border="1" cellpadding="0" cellspacing="0">
		  ...
		  <table border="1" align="center" cellpadding="0" cellspacing="1" id="tabla" class="table-hover record_table" >
			  ...
			  {
			  ?>
			  <td bgcolor="#AEDBE8"><strong>Precio C.</strong></td>
			  <td bgcolor="#AEDBE8"><strong>Precio C. Red P&uacute;blica</strong></td>
			  <td bgcolor="#AEDBE8"><strong>PVP</strong></td>
			  <td bgcolor="#AEDBE8"><strong>PVP Red Publica</strong></td>
			  
			  
			  <td bgcolor="#AEDBE8"><strong>P Techo</strong></td>
