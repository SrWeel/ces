...
//echo $_SESSION['ces1313777_jobt_id'];

if($_SESSION['ces1313777_jobt_id']==2)
...
echo '<th >Editar</th>';
if(@$_SESSION['ces1313777_usua_adm']==1)
{
	echo '<th >Perfil</th>';
	echo '<th >Historial</th>';
	echo '<th >R.Anteriores</th>';
}
...
if(@$_SESSION['ces1313777_sessid_emp_id'])

{



   $sql1=$rs_datosmenu->fields["mnupan_campoenlace"]." = ".@$_SESSION['ces1313777_sessid_emp_id']." and ";
 ...
 $('#datatable1').DataTable( {
		...
		"mRender": function (data,type,full)

				{
				 ...
				 return '<table border="0" cellspacing="0" cellpadding="0" ><tr><td onclick="ver_formularioenpantalla(\'aplicativos/documental/datos_standarusuario.php\',\'Editar\',\'divBody_ext\','+full["<?php echo $campo_id ?>"]+',\'<?php echo $_POST["pVar2"]; ?>\',0,0,0,0,0)" style=cursor:pointer ><center><img src="images/editar.png"  /></center></td></tr></table>';
		...
		"mRender": function (data,type,full)

				{
				 ...
				 return '<table border="0" cellspacing="0" cellpadding="0" ><tr><td onclick="abrir_standar(\'aplicativos/documental/opciones/grid/usuario/perfil.php\',\'Perfil\',\'divBody_perfil\',\'divDialog_perfil\',500,390,'+full["<?php echo $campo_id ?>"]+',0,0,0,0,0,0)" style=cursor:pointer ><center><img src="images/opciones/perfil.png"  /></center></td></tr></table>';
		...
		"mRender": function (data,type,full)

				{
				 ...
				 return '<table border="0" cellspacing="0" cellpadding="0" ><tr><td onclick="abrir_standar(\'aplicativos/documental/opciones/grid/usuario/historialmd.php\',\'Ver_Historial\',\'divBody_perfil\',\'divDialog_perfil\',500,390,'+full["<?php echo $campo_id ?>"]+',0,0,0,0,0,0)" style=cursor:pointer ><center><img src="images/opciones/perfil.png"  /></center></td></tr></table>';
		...
		"mRender": function (data,type,full)

				{
				 ...
				 return '<table border="0" cellspacing="0" cellpadding="0" ><tr><td onclick="abrir_standar(\'aplicativos/documental/opciones/grid/usuario/reganterior.php\',\'Registros_Anteriores\',\'divBody_perfil\',\'divDialog_perfil\',500,390,'+full["<?php echo $campo_id ?>"]+',0,0,0,0,0,0)" style=cursor:pointer ><center><img src="images/opciones/perfil.png"  /></center></td></tr></table>';
