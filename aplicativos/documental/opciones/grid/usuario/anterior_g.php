...
$banderaexiste=0;
$listalinkstr="select * from cesdb_arextension.app_usuariosranteriores where usua_id='".$_POST["usua_idx"]."' and per_codobj=".$_POST["mnupan_idx"];
...
if($banderaexiste)
{
   ...
   $actualiza="update cesdb_arextension.app_usuariosranteriores set per_activo='".$activox_val."' where usua_id='".$_POST["usua_idx"]."' and per_codobj=".$_POST["mnupan_idx"];
...
else
{
   ...
   $actualiza="insert into cesdb_arextension.app_usuariosranteriores (usua_id,per_codobj,per_activo) values ('".$_POST["usua_idx"]."','".$_POST["mnupan_idx"]."','".$activox_val."')";
   $okval = $DB_gogess->executec($actualiza,array());
