...
<?php
 $bodega_principal=$_SESSION['ces1313777_centro_id']; 
...
<div align="center">
   <table border="0" cellpadding="0" cellspacing="0">
	...
	{
	  ?>
	  <input type="button" name="Button" value="Transferencias entre centros" onclick="abrir_standar('egresovarios/grid_egresovarios_nuevo.php','Transferencias_Entre_Centros','divBody_producto','divDialog_producto',800,600,0,0,0,0,0,0,'<?php echo $_GET["insu"]; ?>')" />
	  <?php
	  }
	  ?>
	...
	{
	  ?>
	  <input type="button" name="Button3" value="Descargos Varios" onclick="abrir_standar('egresovarios/grid_egresovarios_nuevo.php','Descargos_Varios','divBody_producto','divDialog_producto',800,600,0,0,0,0,0,7,'<?php echo $_GET["insu"]; ?>')" />
	  <?php
	  }
	  ?>
...
if (confirm("Esta seguro que desea borrar este registro ?"))
	 ...
	 $("#grid_borrarencentro").load("../../../../../aplicativos/documental/opciones/grid/grid_borrarencentro.php",{
     ptabla:tabla,
	 pcampo:campo,
	 pvalor:valor
  },function(result){ 
