		...
		"mRender": function (data,type,full)
				{
				 ...
				 return '<table border="0" cellspacing="0" cellpadding="0" ><tr><td onclick="ver_formularioenpantalla(\'aplicativos/documental/datos_stnnewsalarecuperacionsubsecuente.php\',\'Editar\',\'divBody_ext\','+full["<?php echo $campo_id ?>"]+',\'<?php echo @$_POST["pVar2"]; ?>\',\'<?php echo @$_POST["pVar3"]; ?>\',\'<?php echo @$_POST["pVar4"]; ?>\',\'<?php echo @$tipofor_id; ?>\',\'<?php echo @$anam_id; ?>\',\'<?php echo @$centro_id; ?>\')" style=cursor:pointer ><center><img src="images/editar.png"  /></center></td></tr></table>';
