...
if($_SESSION['ces1313777_centro_id'])
{
  ...
  //$sql4=" centro_id=".$_SESSION['ces1313777_centro_id']." and ";

}


//busca si es administrador
$lista_usd="select * from app_usuario where usua_id='".$_SESSION['ces1313777_sessid_inicio']."'";
...
if($usua_admrecaudacion==0)
{
    if($_SESSION['ces1313777_sessid_inicio'])
	{
	  $sql5=" usua_id='".$_SESSION['ces1313777_sessid_inicio']."' and ";	
	}
		...
		"mRender": function (data,type,full)
				{
				 ...
				 return '<table border="0" cellspacing="0" cellpadding="0" ><tr><td onclick="ver_formularioenpantalla(\'aplicativos/documental/datos_standarcierre.php\',\'Editar\',\'divBody_ext\','+full["<?php echo $campo_id ?>"]+',\'<?php echo $_POST["pVar2"]; ?>\',0,0,0,0,0)" style=cursor:pointer ><center><img src="images/editar.png"  /></center></td></tr></table>';
