...
$query = <<<QUERY
    ...
    WHERE prof_id in (select prof.prof_id from app_usuario us inner join dns_gridfuncionprofesional espe on us.usua_enlace=espe.usua_enlace inner join cesdb_arextension.dns_profesion prof on espe.prof_id=prof.prof_id where prof.prof_id not in (38,777,888,911116,77))  order by prof_nombre asc
QUERY;
